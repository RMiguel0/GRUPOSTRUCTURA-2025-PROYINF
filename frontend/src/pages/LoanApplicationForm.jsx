...
/** * Form for capturing personal information needed to submit a loan application. * Includes optional OCR scanning of identity documents to pre-fill the * identification and full name fields. On submit the application is sent * to the Supabase backend. */ export function LoanApplicationForm() {
            ...
            <div>
              ...
              <label className="block text-sm font-medium text-gray-700 mb-2">
                ...
                <div className="flex items-center gap-2">
                  {" "}
                  <User className="w-4 h-4" /> Identificacion (RUT/DNI) *{" "}
                </div>{" "}
              </label>{" "}
              <input
                type="text"
